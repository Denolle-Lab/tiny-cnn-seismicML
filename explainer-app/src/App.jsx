    ...
    <>
      <article className="copy-block">
        ...
        <figure className="copy-block-figure">
          <img src={publicAsset('images/cnn-patterns-diagram.png')} alt="Diagram: CNN takes an input (e.g. image), processes it through layers to find patterns, and outputs a classification. Below: pipeline from Camera to Preprocessing to CNN to Postprocessing." />
        </figure>
        <p>
      ...
      <section className="section results-section">
        ...
        <div className="results-grid">
          <figure className="results-figure">
            <img src={publicAsset('images/test-predictions-grid.png')} alt="Test predictions: 9 waveforms with True label, Predicted label, and confidence. Green = correct, red = incorrect." />
          ...
          <figure className="results-figure">
            <img src={publicAsset('images/training-validation-curves.png')} alt="Training and validation loss and accuracy for Compact vs Standard models over epochs." />
